...
我们欢迎所有成员的贡献！无论是修复错别字、添加教程，还是分享你的笔记，每一份贡献都至关重要！以下是你可以提供帮助的方式：  
...
> 2. 重现步骤（如适用） 
> 3. 期望与实际行为的对比
> 4. 通过 pull request 提交问题和修改内容。或者联系 core-team 进行反馈修改  
  
### 添加内容  
  
Fork 本仓库创建功能分支, 通过使用以下 git 命令从主分支上新功能分支  
  
```bash  
git checkout -b 分支命名/描述性英文名称
# 示例： git checkout -b feature/unity-animation-tutorial
# 示例:  git checkout -b fix/docs-typo-correction
```
...
# 提交更改（使用有意义的提交信息）
git commit -m "feat: 添加 Unity 动画系统教程"
git commit -m "fix: 修正 C# 基础教程中的代码示例"
git commit -m "docs: 更新 Git 协作指南"
```
...
>
> 4.选择正确的分支:  
> - base repository: [组织名称]/knowledge-base  
> - base: main  
> - head repository: [你的用户名]/knowledge-base  
> - compare: 你的分支名称  
>
...
不知道如何正确操作，或寻求更详细的指南？
> - 查看我们的 Wiki 以寻求帮助  
> - 查看 docs/tutorials 文件中的指南  
> - 在 docs/errors-solutions 文件夹中查找常见的错误及解决方法  
...
本 README 由 重庆工商大学CO科创团队-游戏开发方向 维护。最后更新: 2025年10月27日
